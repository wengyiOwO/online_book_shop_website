...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="MainMenuNoLogin.jsp">
                BOOK BOOK CHUI
            </a>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex mx-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="MainMenuNoLogin">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Login.jsp">Catalogue</a>
                        </li>
                    </ul>
                </div>
