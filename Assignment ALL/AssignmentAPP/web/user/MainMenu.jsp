<%-- 
    Document   : MainMenu
    Created on : 17 Apr 2023, 10:23:20 am
    Author     : louis
--%>
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                ...
                <p class="text-center"><a class="btn btn-success" href="SortByCategory?category=Business%20%26%20Management">View</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                ...
                <p class="text-center"><a class="btn btn-success" href="SortByCategory?category=Health%20%26%20Fitness">View</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a><img src=".././assets/img/travel.png" class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">Travel</h2>
                <p class="text-center"><a class="btn btn-success" href="SortByCategory?category=Travel">View</a></p>
            </div>
        </div>
    </section>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="DisplayBookDetails?bookId=<%= trBooks.getBookId()%>" >Details</a>
                        </div>
                    </div>
