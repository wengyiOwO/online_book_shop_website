...
public class SortByCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String bookCat = URLDecoder.decode(encodedCategory, "UTF-8");
        List<Books> bookCategory = booksService.findBookByCategory(bookCat);
        session.setAttribute("category",bookCat);
        session.setAttribute("bookCategory", bookCategory);
        response.sendRedirect("ProductByCategory.jsp");
