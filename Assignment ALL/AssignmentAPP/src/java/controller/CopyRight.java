...
public class CopyRight extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        copyrights = context.getInitParameter("copyrights");
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Use the initialized values in your servlet logic
        response.setContentType("text/html");
        response.getWriter().println("<h1>Welcome to " + companyName + "</h1>");
        response.getWriter().println("<p>Contact us at: " + companyEmail + "</p>");
        response.getWriter().println("<p>" + copyrights + "</p>");
    }
